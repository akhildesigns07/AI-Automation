...
housing_predictions_for = dec_reg.predict(housing_prepared)
for_mse = mean_squared_error(housing_labels, housing_predictions_for)
for_rmse = np.sqrt(dec_mse)
for_rmse
for_scores = cross_val_score(forest_reg, housing_prepared, housing_labels,
scoring="neg_mean_squared_error", cv=10)
display_scores(for_scores)
